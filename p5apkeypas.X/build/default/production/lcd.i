...
void LCDGotoXY(uint8_t col, uint8_t row)
{
    ...
    switch(row)
    {
        case 0: DDaddr = 0x80; break;
        case 1: DDaddr = 0xC0; break;
        case 2: DDaddr = 0x94; break;
        case 3: DDaddr = 0xD4; break;
    }
    DDaddr += col;
    PORTDbits.RD4 = 0;
    TRISD &= 0xF0;
...
void LCDSetup(void)
{
    ...
    LCDWriteCMD(0x3F & 0x2F);
    LCDWriteCMD(0x0F & 0x0E);
    LCDWriteCMD(0x07 & 0x06);
    LCDWriteCMD(0x01);
    LCDWriteCMD(0x02);
}
